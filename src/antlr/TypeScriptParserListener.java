...
public interface TypeScriptParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TypeScriptParser#typeItem}.
	 * @param ctx the parse tree
	 */
	void enterTypeItem(TypeScriptParser.TypeItemContext ctx);
	/**
	 * Exit a parse tree produced by {@link TypeScriptParser#typeItem}.
	 * @param ctx the parse tree
	 */
	void exitTypeItem(TypeScriptParser.TypeItemContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TypeScriptParser#arrow}.
	 * @param ctx the parse tree
	 */
	void enterArrow(TypeScriptParser.ArrowContext ctx);
	/**
	 * Exit a parse tree produced by {@link TypeScriptParser#arrow}.
	 * @param ctx the parse tree
	 */
	void exitArrow(TypeScriptParser.ArrowContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TypeScriptParser#expressionItem}.
	 * @param ctx the parse tree
	 */
	void enterExpressionItem(TypeScriptParser.ExpressionItemContext ctx);
	/**
	 * Exit a parse tree produced by {@link TypeScriptParser#expressionItem}.
	 * @param ctx the parse tree
	 */
	void exitExpressionItem(TypeScriptParser.ExpressionItemContext ctx);
	/**
