...
public class TypeScriptParser extends Parser {
	...
	public static final int
		...
		Double_Comment=36, Single_Comment=37, WS=38, TYPE_INT=39, TYPE_STRING=40, 
		TYPE_BOOLEAN=41, TYPE_ARRAY=42, TYPE_ANY=43, TYPE_LIST=44, KEYWORD_PUBLIC=45, 
		KEYWORD_PRIVATE=46, KEYWORD_PROTECTED=47, COMMENT=48, KEYWORD_ENUM=49, 
		KEYWORD_LET=50, KEYWORD_CONST=51, KEYWORD_FUNCTION=52, KEYWORD_VOID=53, 
		KEYWORD_IF=54, KEYWORD_ELSE=55, KEYWORD_CONSTRUCTOR=56, KEYWORD_THIS=57, 
		KEYWORD_EXPORT=58, KEYWORD_INTERFACE=59, KEYWORD_FOR=60, KEYWORD_WHILE=61, 
		KEYWORD_IMPORT=62, KEYWORD_FROM=63, KEYWORD_COMPONENT=64, KEYWORD_AS=65, 
		KEYWORD_DEFAULT=66, AT=67, KEYWORD_NGMODULE=68, KEYWORD_CLASS=69, KEYWORD_EXTENDS=70, 
		KEYWORD_IMPLEMENTS=71;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LBRACE", "RBRACE", "LSQUARE", "RSQUARE", "OR", "AND", "SHEE", "Double_Comment", 
			"Single_Comment", "WS", "TYPE_INT", "TYPE_STRING", "TYPE_BOOLEAN", "TYPE_ARRAY", 
			"TYPE_ANY", "TYPE_LIST", "KEYWORD_PUBLIC", "KEYWORD_PRIVATE", "KEYWORD_PROTECTED", 
			"COMMENT", "KEYWORD_ENUM", "KEYWORD_LET", "KEYWORD_CONST", "KEYWORD_FUNCTION", 
			"KEYWORD_VOID", "KEYWORD_IF", "KEYWORD_ELSE", "KEYWORD_CONSTRUCTOR", 
			"KEYWORD_THIS", "KEYWORD_EXPORT", "KEYWORD_INTERFACE", "KEYWORD_FOR", 
			"KEYWORD_WHILE", "KEYWORD_IMPORT", "KEYWORD_FROM", "KEYWORD_COMPONENT", 
			"KEYWORD_AS", "KEYWORD_DEFAULT", "AT", "KEYWORD_NGMODULE", "KEYWORD_CLASS", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8385667323939266808L) != 0) || _la==AT || _la==KEYWORD_CLASS) {
				{
				{
				setState(76);
				statement();
	...
	public final DirectiveElementContext directiveElement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2281701896L) != 0)) {
				{
				{
				setState(149);
				directive();
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8328L) != 0)) {
				{
				setState(172);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final TemplateBindingContext templateBinding() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3750900357421596792L) != 0)) {
				{
				{
				setState(224);
				expression(0);
	...
	public final ArrayLiteralContext arrayLiteral() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3750900357421596792L) != 0)) {
				{
				setState(309);
				expression(0);
				setState(314);
	...
	public static class ImportSpecifierContext extends ParserRuleContext {
		public TerminalNode IDENTIFIER() { return getToken(TypeScriptParser.IDENTIFIER, 0); }
		public List<TerminalNode> KEYWORD_COMPONENT() { return getTokens(TypeScriptParser.KEYWORD_COMPONENT); }
		public TerminalNode KEYWORD_COMPONENT(int i) {
			return getToken(TypeScriptParser.KEYWORD_COMPONENT, i);
		}
		...
		try {
			...
			case KEYWORD_COMPONENT:
				...
				if (_la==KEYWORD_AS) {
					...
					setState(508);
					_la = _input.LA(1);
					if ( !(_la==IDENTIFIER || _la==KEYWORD_COMPONENT) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 80185183990448136L) != 0)) {
				{
				setState(593);
				_errHandler.sync(this);
